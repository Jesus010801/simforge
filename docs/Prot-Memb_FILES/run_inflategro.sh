...
gmx grompp -f minim_inflategro.mdp -c system_inflated.gro -p topol.top -r system_inflated.gro -o system_inflated_em.tpr -maxwarn 1
...
do
    ...
    gmx grompp -f minim_inflategro.mdp -c system_shrink${curr}.gro -r system_shrink${curr}.gro -p topol.top -o system_shrink${curr}_em.tpr -maxwarn 1
